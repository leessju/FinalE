...
StreamingKit is available as a [Cocoapod](https://cocoapods.org/pods/StreamingKit). You can also simply copy all the source files located inside StreamingKit/StreamingKit/* into your Xcode project.
